...
const createPortfolio = async (req, res) => {
  try {
    ...
    form.parse(req, async (err, fields, files) => {
      ...
      // Ensure image exists and extract the first file object if it's an array
      ...
      const storedFileName = photo.newFilename; // Correct way to get the stored filename
      const imageUrl = `https://mern-project-h3ks.onrender.com/uploads/${storedFileName}`;
